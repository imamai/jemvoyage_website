...
-- they reference a media id.
--
-- When an administrator uploads the real photograph, storage_bucket + file_path
-- are populated and take precedence in mediaUrl(); external_url is ignored from
-- then on, and the row stops being a placeholder. No code change, no redeploy.
-- =============================================================================
...
-- external_url instead, so relax NOT NULL and assert at least one source.
alter table public.jemvoyage_media
